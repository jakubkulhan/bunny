...
$connectionContent .= "    }\n";
$connectionContent .= "\n";
$connectionContent .= "    public function flushWriteBuffer(bool \$awaitDrain = true): void\n";
$connectionContent .= "    {\n";
...
$connectionContent .= "        if (!\$this->connection->write(\$data) && \$awaitDrain) {\n";
...
$connectionContent .= "            \$this->flushWriteBuffer(awaitDrain: false);\n";
$connectionContent .= "\n";
$connectionContent .= "            \$this->heartbeatTimer = Loop::addTimer(\$this->configuration->heartbeat, \$this->onHeartbeat(...));\n";
