...
$connectionContent .= "            \$this->disconnect(Constants::STATUS_CONNECTION_FORCED, sprintf('Connection closed by server: (%d) %s', \$frame->replyCode, \$frame->replyText), ClientInterface::RAW_CONNECTION_INACTIVE);\n";
$connectionContent .= "\n";
