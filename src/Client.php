...
final class Client
{
    ...
    public function connect(): self
    {
        ...
        try {
            ...
            $this->connection->connectionTuneOk($tune->channelMax, $tune->frameMax, $this->options["heartbeat"]);
    ...
    protected function authResponse(MethodConnectionStartFrame $start): void
    {
        ...
        $this->connection->connectionStartOk([], "AMQPLAIN", $responseBuffer->read($responseBuffer->getLength()), "en_US");
    }
    ...
    public function disconnect(int $replyCode = 0, string $replyText = ""): void
    {
        ...
        $this->connection->disconnect($replyCode, $replyText, 0, 0);
