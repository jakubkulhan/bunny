...
class ProtocolReader
{
     ...
     * @return array<bool>
     */
    public function consumeBits(Buffer $buffer, int $n): array
    {
        $bits = [];
     ...
     */
    public function consumeDecimalValue(Buffer $buffer): int
    {
     ...
     */
    public function consumeFieldValue(Buffer $buffer): mixed
    {
