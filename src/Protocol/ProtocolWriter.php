...
class ProtocolWriter
{
     ...
     */
    public function appendFrame(AbstractFrame $frame, Buffer $buffer): void
    {
     ...
     */
    public function appendArray(array $value, Buffer $originalBuffer): void
    {
        $buffer = new Buffer();
     ...
     *
     * @param array<mixed> $bits
     */
    public function appendBits(array $bits, Buffer $buffer): void
    {
        $value = 0;
     ...
     */
    public function appendFieldValue(mixed $value, Buffer $buffer): void
    {
        if (is_string($value)) {
